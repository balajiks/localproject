                            ...
                            <section class="panel panel-default">
                                ...
                                <div class="panel-body">
                                    ...
                                    <div id="recurring" class="{{ !$invoice->is_recurring ? 'display-none' : '' }}">
                                        ...
                                        @endphp
                                        <div class="form-group">
                                            <label class="col-md-4 control-label">@langapp('start_date') <span data-toggle="tooltip" title="The date the invoice should start recurring.">@icon('regular/question-circle')</span> </label>
                                            <div class="col-md-8">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-8">
                                                ...
                                                <label>
                                                    ...
                                                    <span class="label-text" data-rel="tooltip" title="Enable this to recur for an unlimited time.">Never Expires</span>
                                                </label>
                                </div>
                                            </div>
                                        </div>
