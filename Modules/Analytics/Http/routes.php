...
Route::group(
    ...
    function () {
		...
		Route::post('filter/indexings', 'AjaxReportsController@indexings')->name('reports.indexings.filter')->middleware('can:menu_reports');
        ...
        Route::post('filter/project-feedback', 'AjaxReportsController@feedback')->name('reports.projects.feedback')->middleware('can:menu_reports');
    }
);
