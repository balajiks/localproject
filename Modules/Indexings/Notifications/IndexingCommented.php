    ...
    public function toMail($notifiable)
    {
        if ($notifiable->channelActive('mail', $this->type)) {
            return (new MailMessage)
                ->subject(langmail('indexings.commented.subject'))
                ->greeting(langmail('indexings.commented.greeting', ['name' => $notifiable->name]))
                ->line(langmail('indexings.commented.body', ['name' => $this->indexing->name]))
