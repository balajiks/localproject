    ...
    <aside>
        <section class="">
            ...
            <header class="header">
                ...
                <a href="{{ route('todo.create', ['module' => 'indexings', 'id' => $indexing->id]) }}" data-toggle="ajaxModal" class="btn btn-success btn-sm pull-right btn-icon" id="new-task" >
                    @icon('solid/plus')
                </a>

                <div class="m-t-sm pull-left text-muted">
                       <label >
                            <input id="checkAll" type="checkbox" data-id="{{ $indexing->id }}" name="indexings" {!! $indexing->todo_percent >= 100 ? 'checked="checked" disabled=""' : '' !!}>
            ...
            <div class="progress progress-xxs progress-striped active"> 
        		<div class="progress-bar progress-bar-success" data-toggle="tooltip" data-original-title="{{ $indexing->todo_percent }}%" data-placement="bottom" style="width: {{ $indexing->todo_percent }}%"></div> 
        	</div>
            ...
            <section class="">
            	...
            	<article class="chat-item" id="chat-form"> 
            		...
            		<section class="chat-body"> 
            			...
            			<input type="hidden" name="module_id" value="{{ $indexing->id }}">
                        <input type="hidden" name="module" value="indexings">
                ...
                @widget('Todos\ShowTodos', ['todos' => $indexing->todos()->where(function ($query) {
