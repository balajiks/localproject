...
/*-----------------------------------------------------------------------------------------------------------*/
        $('#createSection').on('submit', function(e) {
            ...
            axios.post('{{ route('indexings.api.savesection') }}', data)
		...
		$('.section-list').on('click', '.deleteSection', function (e) {
            ...
            axios.delete('{{ get_option("site_url") }}api/v1/indexings/'+id+'/sectionindex', {
                    id: id,
            })
            .then(function (response) {
						...
						alert(@langapp('sectioncnt') - $('#indexersectioncount').val());
						$("#indexer_section").select2({
							maximumSelectionLength: @langapp('sectioncnt') - $('#indexersectioncount').val()
						});
...
/*-----------------------------------------------------------------------------------------------------------*/		
		...
		$('#createMedical').on('submit', function(e) {
		   ...
		   data = indexermedical.serialize();
            axios.post('{{ route('indexings.api.savemedical') }}', data)
            .then(function (response) {
					$("#txtmedicalterm").val('');
		...
		$('#major-mediallistdata').on('click', '.deletemedicalterm', function (e) {
            ...
            axios.delete('{{ get_option("site_url") }}api/v1/indexings/'+id+'/'+jobid+'/'+orderid+'/medicaltermindex', {
                    id: id,
					jobid: jobid,
					orderid: orderid,
            })
		...
		$('#checktag-mediallistdata').on('click', '.deletechecktag', function (e) {
            ...
            axios.delete('{{ get_option("site_url") }}api/v1/indexings/'+id+'/'+jobid+'/'+orderid+'/medicalchecktagtermindex', {
                    id: id,
					jobid: jobid,
					orderid: orderid,
            })
...
/*-----------------------------------------------------------------------------------------------------------*/		
	...
	$('#createDrug').on('submit', function(e) {
            ...
            axios.post('{{ route('indexings.api.savedrug') }}', data)
            .then(function (response) {
					console.log(response);
					<!--return false;-->
		...
		$('#createDrugLinks').on('submit', function(e) {
            ...
            axios.post('{{ route('indexings.api.savedruglinks') }}', data)
            .then(function (response) {
					$("#tabcontent").empty().append(response.data.htmldrugterm);
					$("#preloader").hide();
					
                    toastr.success( response.data.message , '@langapp('response_status') ');
                    $("#savebtn").html('<i class="fas fa-save"></i> @langapp('save') </span>');
		...
		$('#createDrugTradeName').on('submit', function(e) {
		    ...
		    data = indexerdruglinks.serialize();
            axios.post('{{ route('indexings.api.savedrugtradename') }}', data)
            .then(function (response) {
		...
		$('.drugtradename-list').on('click', '.deletetradeterm', function (e) {
            ...
            axios.delete('{{ get_option("site_url") }}api/v1/indexings/'+id+'/drugtrademanufacture', {
                    id: id,
            })
            .then(function (response) {
				toastr.warning( response.data.message , '@langapp('response_status') ');
		...
		$('#ajaxdrugtradename').on('click', '.deleteajaxtradelink', function (e) {
            ...
            axios.delete('{{ get_option("site_url") }}api/v1/indexings/'+id+'/'+value+'/deletedrugtradename', {
                    id: id,
					value: value,
            })
            .then(function (response) {
...
/*-----------------------------------------------------------------------------------------------------------*/		
		...
		$('#createDeviceTradeName').on('submit', function(e) {
            ...
            axios.post('{{ route('indexings.api.savedevicetradename') }}', data)
            .then(function (response) {
		...
		$('#ajaxdevicetradename').on('click', '.deleteajaxtradelink', function (e) {
            ...
            axios.delete('{{ get_option("site_url") }}api/v1/indexings/'+id+'/'+value+'/deletedevicetradename', {
                    id: id,
					value: value,
            })
            .then(function (response) {
...
/*-----------------------------------------------------------------------------------------------------------*/		
	$('#createCtn').on('submit', function(e) {
            ...
            axios.post('{{ route('indexings.api.savectn') }}', data)
            .then(function (response) {
	...
	$('.ctn-list').on('click', '.deleteCtn', function (e) {
            ...
            axios.delete('{{ get_option("site_url") }}api/v1/indexings/'+id+'/drugctnindex', {
                    id: id,
            })
            .then(function (response) {
				toastr.warning( response.data.message , '@langapp('response_status') ');
...
/*-----------------------------------------------------------------------------------------------------------*/		
	...
	$('#createMedicalIndexing').on('submit', function(e) {
		    ...
		    data = indexerctn.serialize();
            axios.post('{{ route('indexings.api.savemedicalindexing') }}', data)
            .then(function (response) {
	...
	$('#major-mediallistdata').on('click', '.deletemedicaldeviceterm', function (e) {
            ...
            axios.delete('{{ get_option("site_url") }}api/v1/indexings/'+id+'/'+jobid+'/'+orderid+'/medicaldevicetermindex', {
                    id: id,
					jobid: jobid,
					orderid: orderid,
            })
