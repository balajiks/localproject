                ...
                <header class="header bg-white b-b clearfix">
                    <div class="row m-t-sm">
                        ...
                        <div class="col-sm-7 m-b-xs">
                            <a href="{{ route('indexings.export') }}" class="btn btn-sm btn-info pull-right">
                ...
                <section class="scrollable wrapper bg">
                    <section class="panel panel-default">
                        <div class="panel-body">
                            {!! Form::open(['route' => 'indexings.csvprocess', 'class' => 'form-horizontal ajaxifyForm']) !!}
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <select name="fields[{{ $key }}]" class="form-control">
                                                    ...
                                                    @foreach (config('db-fields.indexing') as $db_field)
