  ...
  <div id="login-form" class="container aside-xxl animated fadeInUp">
    <section class="panel panel-default bg-white m-t-sm b-r-xs">
      <header class="panel-heading text-center login-heading">
        <strong>Embase Workflow Installation</strong>
      </header>
      <div class="wizard">
        ...
        <div class="step-content clearfix">
          ...
          <form method="post" action="{{ route('LaravelInstaller::environmentSaveWizard') }}" class="config-form tabs-wrap">
            ...
            <div class="form-group {{ $errors->has('app_name') ? ' has-error ' : '' }}">
              ...
              <input type="text" name="app_name" id="app_name" class="form-control" value="{{ old('app_name') }}" placeholder="Embase_v1" required>
            ...
            <div class="form-group {{ $errors->has('app_url') ? ' has-error ' : '' }}">
              ...
              <input type="url" class="form-control" name="app_url" id="app_url" value="{{ request()->getSchemeAndHttpHost() }}" placeholder="https://example.com" required>
            ...
            <div class="form-group {{ $errors->has('database_name') ? ' has-error ' : '' }}">
              ...
              <input type="text" class="form-control" name="database_name" id="database_name" value="{{ old('database_name') }}" placeholder="embase" required>
            ...
            <div class="block">
              ...
              <div class="info">
                <div class="form-group {{ $errors->has('user.name') ? ' has-error ' : '' }}">
                  ...
                  <input type="text" class="form-control" name="user[name]" value="{{ old('user.name') }}" placeholder="administrator" required>
                ...
                <div class="form-group {{ $errors->has('user.email') ? ' has-error ' : '' }}">
                  ...
                  <input type="email" class="form-control" name="user[email]" value="{{ old('user.email') }}" placeholder="admin@spi-global.com" required>
                ...
                <div class="form-group {{ $errors->has('profile.job_title') ? ' has-error ' : '' }}">
                  ...
                  <input type="text" class="form-control" name="profile[job_title]" value="{{ old('profile.job_title') }}" placeholder="administrator" required>
