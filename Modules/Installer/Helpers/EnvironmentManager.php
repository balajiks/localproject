...
class EnvironmentManager
{
    ...
    public function saveFileWizard(Request $request)
    {
        ...
        $envFileData =
        'APP_NAME=\'' . request('app_name', 'Embase') . "'\n" .
        ...
        'APP_URL=' . request('app_url', 'https://localhost:81/embasecloud/') . "\n\n" .
        ...
        'CACHE_PREFIX=' . request('cache_prefix', 'embase') . "\n" .
        'SESSION_LIFETIME=' . request('session_lifetime', '120') . "\n" .
        'FILESYSTEM_DRIVER=' . request('filesystem_driver', 'local') . "\n\n" .
        'MAIL_FROM_ADDRESS=' . request('mail_from_address', 's.balaji3@spi-global.com') . "\n" .
        'MAIL_FROM_NAME=\'' . request('app_name', 'SPiEmbase') . "'\n" .
