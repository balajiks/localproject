                        ...
                        <div class="col-lg-6">
                            ...
                            <div class="panel-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="form-check text-muted">
                                        <label>
                                            <input type="checkbox" name="profile[channels][whatsapp]" {{ in_array('whatsapp', $channels) ? 'checked' : '' }}> <span class="label-text">@langapp('receive_whatsapp_notification') <a href="{{ route('whatsapp.subscribe') }}" class="btn btn-xs btn-success" data-toggle="ajaxModal">@langapp('subscribe')</a> </span>
                                        </label>
                                    </div>
                                    @endif
