            ...
            <section class="panel panel-default">
                    ...
                    <section class="bg chat-list panel-body">
                      ...
                      <section class="panel panel-default">
                        ...
                        @widget('Chats\CreateWidget', ['chatable_type' => 'users' , 'chatable_id' => $user->id, 'cannedResponse' => true])
                        ...
                        @asyncWidget('Chats\WhatsApp', ['chatable_id' => $user->id, 'chatable_type' => 'users'])
