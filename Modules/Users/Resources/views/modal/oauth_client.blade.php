<div class="modal-dialog">
    <div class="modal-content">
        <div class="modal-header">
            ...
            <h4 class="modal-title">New Oauth Client</h4>
        </div>


        <div class="modal-body">

        {!! Form::open(['url' => '/oauth/clients', 'class' => 'bs-example ajaxifyForm']) !!}
        ...
        <div class="form-group">
                <label class="control-label">Oauth Redirect URL @required</label>
                    ...
                    <input type="text" class="form-control" name="redirect" placeholder="https://embase.com/oauth/callback">
    ...
    $('.ajaxifyForm').submit(function (event) {
        ...
        axios.post($(this).attr("action"), data)
            .then(function (response) {
                    toastr.success('Oauth Client setup successfully', '@langapp('response_status') ');
