        ...
        <div class="modal-body">
            ...
            {!! Form::open(['route' => ['users.api.update', $user->id], 'class' => 'bs-example form-horizontal ajaxifyForm', 'method' => 'PUT']) !!}
                ...
                <div class="form-group">
                    <div class="row">
						...
						<div class="col-md-6">
                            ...
                            <select name="department[]" class="select2-option form-control">
				...
				<div class="form-group">
					...
					<div class="col-md-6">
                                <label>@langapp('usertype')</label>
								<select name="jobrole" class="select2-option form-control" >
                                @foreach (App\Entities\Jobtype::all() as $d)
                                    <option value="{{ $d->jobtypeid  }}" {{ $user->profile->userrole == $d->jobtypeid  ? ' selected' : '' }}>
                                        {{ $d->jobtypename }}
                                    </option>
                                @endforeach
                            </select>
                ...
                <div class="form-group">
					...
					<div class="col-md-4">
                        ...
                        <div class="col-md-4">
                            ...
                            <input type="text" value="{{  $user->profile->mobile  }}" placeholder="+14081234567" name="mobile" class="form-control">
                        </div>
                    </div>
                </div>
            ...
            <div class="form-group">
                ...
                <div class="col-md-12">
                            @php
                                ...
                                $availableChannels = config('system.available_channels');
                            @endphp
                            <label class="display-block">@langapp('notifications')</label>
                            <select name="channels[]" class="select2-option form-control" multiple="multiple">
                                @foreach ($availableChannels as $channel)
                                    <option value="{{ $channel }}" {{  in_array($channel, $channels) ? 'selected' : '' }}>{{ ucfirst($channel) }}</option>
                                @endforeach
                            </select>
