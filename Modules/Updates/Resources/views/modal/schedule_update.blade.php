    ...
    <div class="modal-content">
        ...
        <div class="alert alert-warning small">
            <ul>
                ...
                <li>Read more on file and folder permissions </li>
            </ul>
        </div>
            ...
            <div class="form-group">
                ...
                <div class="col-md-9">
                    <div class="input-group date">
                        ...
                        value="{{ timePickerFormat(now()->addMinutes(2)) }}" name="start_time"
            ...
            <p>Your current server time: <strong>{{ dateTimeFormatted(now()) }}</strong></p>
