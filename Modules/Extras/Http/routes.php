...
Route::group(
    ['middleware' => 'web', 'prefix' => 'extras', 'namespace' => 'Modules\Extras\Http\Controllers'],
    function () {
        ...
        Route::post('whatsapp/send', 'ChatController@send')->name('extras.chats.create');
        Route::post('chats/delete', 'ChatController@delete')->name('extras.chats.delete');
    }
);
