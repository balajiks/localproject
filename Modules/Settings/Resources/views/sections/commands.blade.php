            ...
            <div class="col-sm-4">
              <section class="panel panel-default">
                ...
                <div class="m-xs">
                  ...
                  <a class="btn btn-{{ get_option('theme_color') }} btn-sm btn-block m-b-xs commandBtn" href="#" data-rel="tooltip" data-id="app-cleaner" title="Permanently delete soft deleted records">app:cleaner</a>
                </div>
              </section>
            </div>
          </div>
