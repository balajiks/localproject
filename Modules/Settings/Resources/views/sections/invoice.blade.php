            ...
            <div class="panel-body">
                ...
                <div class="form-group">
                    <label class="col-lg-3 control-label">@langapp('ref_digits')
                        <span class="" data-rel="tooltip" title="Number of digits for Invoice Reference Number. Between 1 and 9">@icon('solid/question-circle')</span>
                    </label>
                    <div class="col-lg-6">
                        <input type="number" min="1" max="9" name="ref_digits" class="form-control" value="{{ get_option('ref_digits') }}">
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <span class="" data-rel="tooltip" title="Invoice numbers should start from this number">@icon('solid/question-circle')</span>
                </label>
                    <div class="col-lg-6">
                            ...
                            <div class="col-sm-6">
                                ...
                                <div class="checkbox">
                                    <label>
                                        ...
                                        <span class="label-text" data-rel="tooltip" title="Keep incrementing invoice numbers">@langapp('increment_invoice_number')</span>
                                    </label>
                                </div>
