    ...
    <div class="col-lg-12">
        ...
        <div class="panel-body">
            <fieldset>
                ...
                <div class="form-group">
                    <label class="col-lg-3 control-label">@langapp('leads_email')</label>
                    <div class="col-lg-7">
                        <input type="text" class="form-control" value="{{ get_option('leads_email') }}" placeholder="leads@example.com" data-toggle="tooltip"
                        data-placement="top" data-original-title="Email used to contact leads" name="leads_email">
                    </div>
                </div>

                <div class="form-group">
                    <label class="col-lg-3 control-label">@langapp('leads_email_name')</label>
                    <div class="col-lg-7">
                        <input type="text" class="form-control" value="{{ get_option('leads_email_name') }}" placeholder="Acme Marketing" data-toggle="tooltip"
                        data-placement="top" data-original-title="Name that displays when you send email to leads" name="leads_email_name">
                    </div>
            </div>
