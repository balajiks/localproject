<div class="row">
    <div class="col-lg-12">
        ...
        <div class="panel-body">
            ...
            <div class="form-group">
                    <label class="col-lg-3 control-label">@langapp('support_email')</label>
                    <div class="col-lg-5">
                        <input type="text" class="form-control" value="{{ get_option('support_email') }}" placeholder="support@example.com" data-toggle="tooltip"
                        data-placement="top" data-original-title="Email used for support emails" name="support_email">
                    </div>
            </div>
            <div class="form-group">
                    <label class="col-lg-3 control-label">@langapp('support_email_name')</label>
                    <div class="col-lg-5">
                        <input type="text" class="form-control" value="{{ get_option('support_email_name') }}" placeholder="Acme Desk" data-toggle="tooltip"
