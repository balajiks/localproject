...
@endphp
            ...
            <div class="panel-body">
                ...
                <div class="form-group">
                    <label class="col-lg-3 control-label">ApiWha Token <span data-toggle="tooltip" title="API Key obtained from ApiWha">@icon('regular/question-circle')</span></label>
                    <div class="col-lg-6">
                ...
                <div class="form-group">
                    <label class="col-lg-3 control-label">WhatsApp Number <span data-toggle="tooltip" title="Default whatsapp number">@icon('regular/question-circle')</span></label>
                    <div class="col-lg-6">
                ...
                <div class="form-group">
                    <label class="col-lg-3 control-label">WhatsApp Subscribe Text <span data-toggle="tooltip" title="Text that users need to send to your whatsapp to subscribe. Default is SUB">@icon('regular/question-circle')</span></label>
                    <div class="col-lg-6">
                            ...
                            <div class="col-sm-6">
                                ...
                                <div class="checkbox">
                                    <label>
                                        ...
                                        <span class="label-text" data-rel="tooltip" title="Enable WhatApp Integration.">@langapp('whatsapp_enabled') @icon('brands/whatsapp','text-success') </span>
                                    </label>
                                </div>
                            ...
                            <div class="col-sm-6">
                                ...
                                <div class="checkbox">
                                    <label>
                                        ...
                                        <span class="label-text" data-rel="tooltip" title="This action will automatically fetch daily exchange rates for foreign currencies.">@langapp('update_xrates')  </span>
                                    </label>
                                </div>
                                ...
                                <div class="checkbox">
                                    <label>
                                        ...
                                        <span class="label-text" data-rel="tooltip" title="Enable Google ReCaptcha.">@langapp('use_recaptcha') </span>
                                    </label>
                                </div>
