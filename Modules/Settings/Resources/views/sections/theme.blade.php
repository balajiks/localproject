                ...
                <div class="form-group">
                    ...
                    <div class="col-lg-2">
                        @if (get_option('login_bg') != '') 
                            <div class="settings-image">
                                <img src="{{ get_option('site_url') }}{{ getStorageUrl(config('system.media_dir').'/'.get_option('login_bg'))  }}"/>
                                </div>
                        @endif
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-lg-2">
                        @if (get_option('site_favicon') != '') 
                            <div class="settings-image">
                                <img src="{{ get_option('site_url') }}{{ getStorageUrl(config('system.media_dir').'/'.get_option('site_favicon'))  }}"/>
                            </div>
                        @endif
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="col-lg-2">
                        @if (get_option('site_appleicon') != '') 
                            <div class="settings-image">
                                <img src="{{ get_option('site_url') }}{{ getStorageUrl(config('system.media_dir').'/'.get_option('site_appleicon'))  }}"/>
                            </div>
                        @endif
                    </div>
                </div>
