...
Route::group(
    ...
    function () {
        ...
        Route::post('menu/reorder', 'SettingController@reorderMenu')->name('menu.reorder')->middleware(['can:settings_update','demo']);
        Route::post('menu/icon/{module}', 'SettingController@menuIcon')->name('menu.icon')->middleware('can:settings_update');
        Route::post('menu/visible/{module}', 'SettingController@menuVisible')->name('menu.visible')->middleware(['can:settings_update', 'demo']);
        ...
        Route::delete('currencies/destroy/{id}', 'CurrencyController@destroy')->name('settings.currencies.destroy')->middleware(['can:settings_update','demo']);
		...
		//Route::get('jobtypes/{module}', 'JobtypesController@jobtypes')->name('settings.jobtypes.show')->middleware('can:settings_update');
		
		
        Route::get('stages/{module}', 'StagesController@stages')->name('settings.stages.show')->middleware('can:settings_update');
		Route::post('stages/selectedjobs', 'StagesController@selectedjobs')->name('settings.stages.selectedjobs')->middleware('can:settings_update');
        ...
        Route::post('stages/delete', 'StagesController@delete')->name('settings.stages.delete')->middleware(['can:settings_update','demo']);
        ...
        Route::post('departments/delete', 'DepartmentController@delete')->name('departments.delete')->middleware(['can:settings_update','demo']);
        ...
        Route::post('sources/delete', 'SourceController@delete')->name('settings.sources.delete')->middleware(['can:settings_update','demo']);
        ...
        Route::post('pipelines/delete', 'PipelinesController@delete')->name('settings.pipelines.delete')->middleware(['can:settings_update','demo']);
        ...
        Route::post('statuses/delete', 'StatusController@delete')->name('settings.statuses.delete')->middleware(['can:settings_update','demo']);
        ...
        Route::post('calendars/delete', 'CalendarController@delete')->name('settings.calendars.delete')->middleware(['can:settings_update','demo']);
