...
Route::group(
    ...
    function () {
        ...
        Route::post('admin-data', 'AdminSubscriptionController@tableData')->name('subscriptions.admin.data')->middleware('can:menu_subscriptions');
        Route::post('client-data', 'ClientSubscriptionController@tableData')->name('subscriptions.client.data')->middleware('can:menu_subscriptions');
        Route::post('admin-plans', 'AdminSubscriptionController@plansData')->name('plans.data')->middleware('can:menu_subscriptions');
