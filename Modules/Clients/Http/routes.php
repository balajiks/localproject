...
Route::group(
    ['middleware' => 'web', 'prefix' => 'clients', 'namespace' => 'Modules\Clients\Http\Controllers'],
    function () {
        ...
        Route::post('table-json', 'ClientCustomController@tableData')->name('clients.data')->middleware('can:menu_clients');
