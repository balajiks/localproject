        ...
        <section class="panel-body">
            ...
            @if(!empty($lead->mobile))
                ...
                <span class="text-bold text-danger">
                        ...
                        <a href="{{ route('leads.consent.whatsapp', $lead->id) }}" class="btn btn-xs btn-success" data-rel="tooltip" title="Request whatsapp consent">@icon('brands/whatsapp') @langapp('subscribe')</a>
                        @endif
                </span>
                @endif
            </p>
