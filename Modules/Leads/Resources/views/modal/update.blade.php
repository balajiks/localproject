        ...
        <div class="modal-body">
                ...
                <div class="tab-pane fade in active" id="tab-lead-general">
                    ...
                    <div class="form-group col-md-6 no-gutter-left">
                        ...
                        <input type="text" name="mobile" class="input-sm form-control" data-rel="tooltip"
                               data-placement="top" title="Example Format: +14081234567 for (country code +1) Area code 408 and phone number 123-4567" value="{{ $lead->mobile }}">
                    </div>
                    <div class="form-group col-md-6 no-gutter-right">
            ...
            <div class="tab-pane fade in" id="tab-lead-message">
                <div class="form-group">
                    ...
                    <textarea name="message" class="form-control markdownEditor" required>{{ $lead->message }} </textarea>
                </div>
