                        ...
                        <section class="scrollable">
                            <div id="tabs">
                                <ul class="nav nav-tabs" id="prodTabs">
                                    ...
                                    <li><a href="#tab_todos" data-url="{{get_option('site_url')}}tasks/ajax/todos/{{ $task->id }}">@langapp('todo')</a></li>
                                    <li><a href="#tab_timesheets" data-url="{{get_option('site_url')}}tasks/ajax/timesheets/{{ $task->id }}">@langapp('timesheets')</a></li>
                                </ul>
