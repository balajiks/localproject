    ...
    <div class="col-lg-4 b-r">
        ...
        <section class="panel-body">
            ...
            <div class="m-xs m-b-sm">
                    <span class="text-muted" data-rel="tooltip" title="GDPR Privacy"><?php echo e(langapp('data_processing')); ?>:</span>
                    <span class="text-bold text-danger"><?php echo e(is_null($lead->unsubscribed_at) ? '✔︎' : '✘'); ?>

                        <?php if(!is_null($lead->unsubscribed_at)): ?>
                        <a href="<?php echo e(route('leads.consent', ['lead' => $lead->id])); ?>" class="btn btn-xs btn-success" data-rel="tooltip" title="Send Consent"><?php echo e(svg_image('solid/user-lock')); ?></a>
                        <?php endif; ?>
                    </span>
            </div>

            <div class="progress progress-xs progress-striped active">
                    <div class="progress-bar progress-bar-success" data-toggle="tooltip" data-original-title="<?php echo e($lead->score); ?>%" style="width:<?php echo e($lead->score); ?>%"></div>
                  </div>
            ...
            <?php if(!empty($lead->mobile)): ?>
                ...
                <p><?php echo e($lead->mobile); ?> 
                <?php if(settingEnabled('whatsapp_enabled')): ?>
                <span class="text-bold text-danger">
                        <?php if(!$lead->whatsapp_optin): ?>
                        <a href="<?php echo e(route('leads.consent.whatsapp', $lead->id)); ?>" class="btn btn-xs btn-success" data-rel="tooltip" title="Request whatsapp consent"><?php echo e(svg_image('brands/whatsapp')); ?> <?php echo trans('app.'.'subscribe'); ?></a>
                        <?php endif; ?>
                </span>
                <?php endif; ?>
            </p>
           ...
           <?php if(!empty($lead->timezone)): ?>
            ...
            <?php if(!empty($lead->twitter)): ?>
                        <a href="<?php echo e($lead->twitter); ?>" target="_blank" class="btn btn-rounded btn-twitter btn-icon shadowed">
                            <?php echo e(svg_image('brands/twitter')); ?>
                        </a>
            <?php endif; ?>

            <?php if(!empty($lead->facebook)): ?>
                    <a href="<?php echo e($lead->facebook); ?>" target="_blank" class="btn btn-rounded btn-info btn-icon shadowed">
                        <?php echo e(svg_image('brands/facebook')); ?>
                    </a>
            <?php endif; ?>

            <?php if(!empty($lead->linkedin)): ?>
                    <a href="<?php echo e($lead->linkedin); ?>" target="_blank" class="btn btn-rounded btn-primary btn-icon shadowed">
                        <?php echo e(svg_image('brands/linkedin')); ?>
                    </a>
            <?php endif; ?>

                    <?php if(!empty($lead->website)): ?>
                        <a href="<?php echo e($lead->website); ?>" target="_blank" class="btn btn-rounded btn-danger btn-icon shadowed">
            ...
            <div class="map">
                <a href="<?php echo e($lead->maplink); ?>" rel="nofollow" target="_blank">
        <img src="//maps.googleapis.com/maps/api/staticmap?center=<?php echo e($lead->map); ?>&amp;zoom=14&amp;scale=2&amp;size=600x340&amp;maptype=roadmap&amp;format=png&amp;visual_refresh=true&amp;key=AIzaSyAzrmdGlvKbFu9F7vPaY0Jg74q1WQo7B0w" alt="Google Map">
