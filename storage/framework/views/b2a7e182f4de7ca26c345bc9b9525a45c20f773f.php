...
// Field 3 - Saved Data
		...
		$devicetradename 			= DB::table('devicetradename')->where($matchThese)->get()->toArray();
		$devicetradenametypecount 	= DB::table('devicetradename')->select('type', DB::raw('count(*) as total'))->where($matchThese)->groupBy('type')->pluck('total','type')->all();
		$data['devicetradename']   		= $devicetradename;
		$data['devicetradenametypecount'] = $devicetradenametypecount;
?>
      ...
      <div class="panel-body">
        <div class="slim-scroll">
          <div class="form-group">
            <div class="col-md-6">
              <ol class="devicetradename-list"  style="margin:0px; padding:0px;">
                <?php $__currentLoopData = $devicetradename; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $termsdata): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
			 ...
			 <div class="col-md-6" id="ajaxdevicetradename">
