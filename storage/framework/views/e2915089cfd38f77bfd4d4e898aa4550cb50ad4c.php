  ...
  <div class="col-lg-12">
    <section class="panel panel-default">
      <header class="panel-heading">
        <header class="btn btn-primary btn-sm" style="margin-left:20px;"> <?php echo e(svg_image('solid/exclamation-circle')); ?> <?php echo trans('app.'.'mdtn'); ?></header>
      </header>
      <?php 
      ...
      <div class="panel-body">
        <div class="col-md-12"> 
              <?php echo Form::open(['route' => 'indexings.api.savedevicetradename', 'id' => 'createDeviceTradeName', 'class' => 'bs-example form-horizontal m-b-none']); ?>
              ...
              <div class="col-md-6">
                ...
                <div class="form-group">
                  <div class="col-lg-2">
                    ...
                    <span class="label-text text-info"><?php echo trans('app.'.'mv'); ?></span></label>
                  </div>
                  <div class="col-lg-2">
                    <label>
                    <input type="radio" id="txtdevicetv" name="termDTNindexing" value="0">
                    <span class="label-text text-info"><?php echo trans('app.'.'tv'); ?></span></label>
                  </div>
                </div>
                <div class="form-group">
                  <div class="col-lg-12">
                    <div class="form-group" id="divmvname">
                      <div class="col-lg-6">
                        <label class="control-label" for="fname"><?php echo trans('app.'.'dmn'); ?></label>
                        <input type="text" class="form-control" id="txtdevicemanufacturename" placeholder="<?php echo trans('app.'.'dmn'); ?>" name="txtdevicemanufacturename" disabled="disabled" value="<?php echo e(@$data['txtdevicemanufacturename']); ?>" autocomplete="off" />
                        <div id="suggesstiondevicetrade-box"></div>
                      </div>
                      <div class="col-lg-5">
                        <label class="control-label" for="fname"><?php echo trans('app.'.'cntrycode'); ?></label>
                        <input type="text" class="form-control" id="txtcountrycode" placeholder="<?php echo trans('app.'.'cntrycode'); ?>" name="txtcountrycode" disabled="disabled" value="<?php echo e(@$data['txtcountrycode']); ?>" autocomplete="off" />
                    ...
                    <div class="form-group" id="divtvname">
                      <div class="col-lg-6 input_fields_wrap" >
                        <label class="control-label" for="fname"><?php echo trans('app.'.'dtn'); ?></label>
                        <input type="text" class="form-control" id="txtdevicetradename" placeholder="<?php echo trans('app.'.'dtn'); ?>" name="txtdevicetradename[]" disabled="disabled" value="<?php echo e(@$data['txtdevicetradename']); ?>" autocomplete="off" />
                      </div>
                      <div class="col-lg-2">
...
<?php echo renderAjaxButtonSquare('save'); ?> </div>
			  ...
			  <div class="col-md-6">
			  <div class="form-group">
					<div class="devicetrade-list" id="nestable"> <?php echo app('arrilot.widget')->run('Indexings\ShowDeviceTradeName', ['user_id' => \Auth::id(), 'jobid' => $jobdata->id, 'orderid' => $jobdata->orderid]); ?> </div>
...
function ajaxtradename(val){
   if(val !='') {
	...
	$("#ajaxterm-"+val).addClass("activeli");
		...
		axios.post('<?php echo e(get_option('site_url')); ?>api/v1/indexings/ajax/devicetradenamedata', {
			selectedterm: val
		})
		.then(function (response) {
...
function selectedCountry(name){
	...
	$(add_button).click(function(e){ 
		...
		if(x < max_fields){
			x++; 
				$(wrapper).append('<div><input type="text" class="form-control" id="txtdevicetradename" placeholder="<?php echo trans('app.'."dtn"); ?>" name="txtdevicetradename[]" value="<?php echo e(@$data['txtdevicetradename']); ?>" autocomplete="off" /><a href="#" class="remove_field btn btn-danger btn-xs">Remove</a></div>'); 
		}
	});
