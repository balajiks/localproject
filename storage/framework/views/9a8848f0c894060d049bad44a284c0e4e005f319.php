                    ...
                    <section class="scrollable wrapper bg">
                        ...
                        <div class="sub-tab text-uc small m-b-sm">
                            ...
                            <ul class="nav pro-nav-tabs nav-tabs-dashed">
                                ...
                                <li class="<?php echo e(($tab == 'whatsapp') ? 'active' : ''); ?>">
                                    <a href="<?php echo e(route('users.view', ['id' => $user->id, 'tab' => 'whatsapp'])); ?>">
                                        <?php echo e(svg_image('brands/whatsapp','text-success')); ?> WhatsApp
                                    </a>
                                </li>
