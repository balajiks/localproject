                    ...
                    <div class="col-lg-2">
                        <?php if(get_option('company_logo') != ''): ?> 
                            <div class="settings-image">
                                <img src="<?php echo e(get_option('site_url')); ?><?php echo e(getStorageUrl(config('system.media_dir').'/'.get_option('company_logo'))); ?>"/>
                            </div>
                        <?php endif; ?>
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-lg-2">
                        <?php if(get_option('login_bg') != ''): ?> 
                            <div class="settings-image">
                                <img src="<?php echo e(get_option('site_url')); ?><?php echo e(getStorageUrl(config('system.media_dir').'/'.get_option('login_bg'))); ?>"/>
                                </div>
                        <?php endif; ?>
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-lg-2">
                        <?php if(get_option('site_favicon') != ''): ?> 
                            <div class="settings-image">
                                <img src="<?php echo e(get_option('site_url')); ?><?php echo e(getStorageUrl(config('system.media_dir').'/'.get_option('site_favicon'))); ?>"/>
                            </div>
                        <?php endif; ?>
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="col-lg-2">
                        <?php if(get_option('site_appleicon') != ''): ?> 
                            <div class="settings-image">
                                <img src="<?php echo e(get_option('site_url')); ?><?php echo e(getStorageUrl(config('system.media_dir').'/'.get_option('site_appleicon'))); ?>"/>
                            </div>
                        <?php endif; ?>
                    </div>
                </div>
