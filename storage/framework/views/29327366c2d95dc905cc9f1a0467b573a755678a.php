    ...
    <div id="lobilist-list-0"
        ...
        <div class="lobilist-header ui-sortable-handle">
            <div class="lobilist-title text-ellipsis">
                <span class="arrow right"></span>📆 <?php echo trans('app.'.'tomorrow'); ?> - <span class="small text-muted"><?php echo e(now()->tomorrow()->toFormattedDateString()); ?></span>
            </div>
        </div>
        <div class="lobilist-body scrumboard slim-scroll" data-height="450" data-disable-fade-out="true"
            ...
            <ul class="lobilist-items ui-sortable list" id="today">
                <?php $todoCounter = 0; ?>
                <?php $__currentLoopData = Auth::user()->tomorrow()->pending()->get(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $todo): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        ...
        <div class="lobilist-footer">
            <strong>
            <?php echo e(Auth::user()->tomorrow()->done()->count()); ?> <?php echo trans('app.'.'done'); ?>
            </strong>
