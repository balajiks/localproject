  ...
  <div class="col-lg-12">
    <section class="panel panel-default">
      <header class="panel-heading">
        <header class="btn btn-primary btn-sm" style="margin-left:20px;"> <?php echo e(svg_image('solid/exclamation-circle')); ?> <?php echo trans('app.'.'drugalertinfo'); ?>  &nbsp;&nbsp;[ <span class="btn btn-warning btn-xs"><?php echo trans('app.'.'drugindexing'); ?> </span> ]</header>
      </header>
      <?php 
        ...
        <div class="col-md-12"> <?php if(count($translations) > 0): ?>
          <div class="tab-content tab-content-fix">
            <div class="tab-pane fade in active" id="tab-english"> <?php endif; ?>
              <?php echo Form::open(['route' => 'indexings.api.savedrug', 'id' => 'createDrug', 'class' => 'bs-example form-horizontal m-b-none']); ?>
              ...
              <div class="col-md-12">
                ...
                <div class="form-group">
                  ...
                  <div class="col-lg-4"> <?php echo renderAjaxButtonSquare('save'); ?> </div>
                </div>
              </div>
              <?php echo Form::close(); ?>
              ...
              <div class="row">
                <div class="col-md-4">
                  <div class="sortable">
                    <div class="drug-list" id="nestable"> <?php echo app('arrilot.widget')->run('Indexings\ShowDrugterms', ['user_id' => \Auth::id(), 'jobid' => $jobdata->id, 'orderid' => $jobdata->orderid]); ?> </div>
                  </div>
                </div>
                <div class="col-md-8">
                          ...
                          <div class="col-md-12">
                            <div class="vertical-tab disabledbutton" role="tabpanel" id="vertical-tab-menu">
                              ...
                              <ul class="nav nav-tabs" role="tablist">
                                <li role="presentation" class="othermenu"><a href="<?php echo e(route('indexings.api.frmdrugotherfield')); ?>" id="tab1" class="tabmenu">Other Fields</a></li>
                                <li role="presentation" class="drugmenu"><a href="<?php echo e(route('indexings.api.frmdrugtherapy')); ?>" id="tab2" class="tabmenu"><?php echo trans('app.'.'drugtherapy'); ?></a></li>
                                <li role="presentation" class="drugmenu"><a href="<?php echo e(route('indexings.api.frmdrugdoseinfo')); ?>" id="tab3" class="tabmenu"><?php echo trans('app.'.'drugdoseinfo'); ?></a></li>
                                <li role="presentation" class="drugmenu"><a href="<?php echo e(route('indexings.api.frmrouteofdrug')); ?>" id="tab4" class="tabmenu"><?php echo trans('app.'.'routeofdrug'); ?></a></li>
                                <li role="presentation" class="drugmenu"><a href="<?php echo e(route('indexings.api.frmdosefrequency')); ?>" id="tab5" class="tabmenu"><?php echo trans('app.'.'dosefrequency'); ?></a></li>
                                <li role="presentation" class="drugmenu"><a href="<?php echo e(route('indexings.api.frmdrugcombination')); ?>" id="tab6" class="tabmenu"><?php echo trans('app.'.'drugcombination'); ?></a></li>
                                <li role="presentation" class="drugmenu"><a href="<?php echo e(route('indexings.api.frmadversedrug')); ?>" id="tab7" class="tabmenu"><?php echo trans('app.'.'adversedrug'); ?></a></li>
                                <li role="presentation" class="drugmenu"><a href="<?php echo e(route('indexings.api.frmdrugcomparison')); ?>" id="tab8" class="tabmenu"><?php echo trans('app.'.'drugcomparison'); ?></a></li>
                                <li role="presentation" class="drugmenu"><a href="<?php echo e(route('indexings.api.frmdrugdosage')); ?>" id="tab9" class="tabmenu"><?php echo trans('app.'.'drugdosage'); ?></a></li>
                                <li role="presentation" class="drugmenu"><a href="<?php echo e(route('indexings.api.frmdruginteraction')); ?>" id="tab10" class="tabmenu"><?php echo trans('app.'.'druginteraction'); ?></a></li>
                                <li role="presentation" class="drugmenu"><a href="<?php echo e(route('indexings.api.frmdrugpharma')); ?>" id="tab11" class="tabmenu"><?php echo trans('app.'.'drugpharma'); ?></a></li>
								
								<li role="presentation" class="drugmenu"><a href="<?php echo e(route('indexings.api.frmdrugtradename')); ?>" id="tab12" class="tabmenu"><?php echo trans('app.'.'drugtradename'); ?></a></li>
                              </ul>
                              <!-- Tab panes -->
                              <?php echo Form::open(['route' => 'indexings.api.savedruglinks', 'id' => 'createDrugLinks', 'class' => 'bs-example form-horizontal m-b-none']); ?>
...
function loadTabContent(tabUrl){
	...
	axios.post(tabUrl, {
		...
		jobid		:	'<?php echo e($jobdata->id); ?>',
		orderid		:	'<?php echo e($jobdata->orderid); ?>',
		pui			:	'<?php echo e($jobdata->pui); ?>',
...
$(document).ready(function(){  
	$('#txtdrugmedicalterm').keyup(function(){  
		   ...
		   if(keyvalue !='') {
				axios.post('<?php echo e(get_option('site_url')); ?>api/v1/indexings/ajax/termdrug', {
					searchterm: keyvalue
				})
				.then(function (response) {
