    ...
    <section class="vbox">
        <header class="header bg-white b-b b-light">
            <div class="btn-group pull-right">
                <a href="<?php echo e(route('leads.index', ['view' => 'table'])); ?>" data-rel="tooltip" title="Table" data-placement="bottom" class="btn btn-sm btn-default">
                    <?php echo e(svg_image('solid/th')); ?>
                </a>
                <a href="<?php echo e(route('leads.index', ['view' => 'kanban'])); ?>" data-rel="tooltip" title="Kanban" data-placement="bottom" class="btn btn-sm btn-default">
                    <?php echo e(svg_image('solid/align-justify')); ?>
                </a>
                <a href="<?php echo e(route('leads.index', ['view' => 'heatmap'])); ?>" data-rel="tooltip" title="Heatmap" data-placement="bottom" class="btn btn-sm btn-success">
            ...
            <a href="<?php echo e(route('leads.create')); ?>" data-toggle="ajaxModal" data-rel="tooltip" title="<?php echo trans('app.'.'create'); ?>" class="btn btn-sm btn-<?php echo e(get_option('theme_color')); ?>">
                <?php echo e(svg_image('solid/plus')); ?> <?php echo trans('app.'.'create'); ?>
            </a>
            
            <?php if (\Illuminate\Support\Facades\Blade::check('admin')): ?>
            <a href="<?php echo e(route('settings.stages.show', 'leads')); ?>" data-toggle="ajaxModal" class="btn btn-sm btn-<?php echo e(get_option('theme_color')); ?> pull-right" data-rel="tooltip" title="<?php echo trans('app.'.'stages'); ?>" data-placement="bottom">
            ...
            <a href="<?php echo e(route('leads.export')); ?>" title="<?php echo trans('app.'.'export'); ?>  " class="btn btn-sm btn-<?php echo e(get_option('theme_color')); ?>">
                                            ...
                                            <div id="lobilist-list-0"
                                                ...
                                                <div class="lobilist-body scrumboard slim-scroll" data-disable-fade-out="true"
                                                    ...
                                                    <ul class="lobilist-items ui-sortable list"
                                                        ...
                                                        <li id="<?php echo e($lead->id); ?>" draggable="true" class="lobilist-item kanban-entry grab <?php echo e(!is_null($lead->unsubscribed_at) ? 'subscribe-bg' : ''); ?>">
                                                            <div class="lobilist-item-title text-ellipsis m-l-xs font14">
                                                                <a href="<?php echo e(route('leads.view', ['id' => $lead->id])); ?>" class=""><?php echo e($lead->name); ?></a>
                                                ...
                                                <div class="lobilist-footer">
                                                    ...
                                                    <strong class="pull-right"><?php echo e($leadCounter); ?> Lead(s)</strong>
                                                </div>
                                            </div>
                                        </div>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
