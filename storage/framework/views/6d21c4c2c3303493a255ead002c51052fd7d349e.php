<div class="modal-dialog">
                ...
                <?php echo Form::open(['route' => 'users.api.save', 'class' => 'bs-example form-horizontal ajaxifyForm']); ?>
                    ...
                    <div class="form-group">
                        <div class="row">
							...
							<div class="col-md-6">
                                <label class="display-block"><?php echo trans('app.'.'department'); ?> <span class="text-danger">*</span> </label>
    
    
                                <select name="department[]" class="select2-option form-control" required>
    ...
    <div class="form-group">
                        <div class="row">
                            <div class="col-md-6">
                                <label><?php echo trans('app.'.'usertype'); ?> <span class="text-danger">*</span> </label>
    
                                <select name="userrole" class="select2-option form-control" required>
                                        <?php $__currentLoopData = App\Entities\Jobtype::all(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $d): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option value="<?php echo e($d->jobtypeid); ?>">
                                                <?php echo e($d->jobtypename); ?> 
                                            </option>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                </select>
                            </div>
                    ...
                    <div class="form-group">
						...
						<div class="col-md-4">
                                ...
                                <input type="text" class="form-control" name="hourly_rate" placeholder="0">
                            </div>
                            <div class="col-md-4">
                            ...
                            <div class="col-md-4">
                                ...
                                <input type="text" name="mobile" class="form-control" placeholder="+14081234567">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <input type="text" name="website" class="form-control" placeholder="https://embase.com">
                            </div>
                            <div class="col-md-6">
                                <label>Twitter</label>
