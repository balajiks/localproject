...
<ol class="dd-list" id="ajaxtradename-listdata">
  <?php $__currentLoopData = $data['drugtradename']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tradelink): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
