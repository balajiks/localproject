...
<section class="vbox" id="app"> <?php echo $__env->make('partial.top_header', \Illuminate\Support\Arr::except(get_defined_vars(), array('__data', '__path')))->render(); ?>
  <section class="">
    <section class="hbox stretch"> <?php echo $__env->make('partial.main_menu', \Illuminate\Support\Arr::except(get_defined_vars(), array('__data', '__path')))->render(); ?>
...
<script src="<?php echo e(getAsset('plugins/intro/tour.js')); ?>"></script>
<?php endif; ?>
...
<?php /*?>@include('partial.ajaxifyindexer')<?php */?>
<script>
