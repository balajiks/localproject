...
?>
            ...
            <div class="panel-body">
                ...
                <div class="form-group">
                    <label class="col-lg-3 control-label">ApiWha Token <span data-toggle="tooltip" title="API Key obtained from ApiWha"><?php echo e(svg_image('regular/question-circle')); ?></span></label>
                    <div class="col-lg-6">
                        <input type="text" class="form-control" value="<?php echo e(get_option('whatsapp_key')); ?>" name="whatsapp_key">
                    </div>
                </div>

                <div class="form-group">
                    <label class="col-lg-3 control-label">WhatsApp Number <span data-toggle="tooltip" title="Default whatsapp number"><?php echo e(svg_image('regular/question-circle')); ?></span></label>
                    <div class="col-lg-6">
                        <input type="text" class="form-control" placeholder="+14081234567" value="<?php echo e(get_option('whatsapp_number')); ?>" name="whatsapp_number">
                    </div>
                </div>

                <div class="form-group">
                    <label class="col-lg-3 control-label">WhatsApp Subscribe Text <span data-toggle="tooltip" title="Text that users need to send to your whatsapp to subscribe. Default is SUB"><?php echo e(svg_image('regular/question-circle')); ?></span></label>
                    <div class="col-lg-6">
                        <input type="text" class="form-control" placeholder="SUB" value="<?php echo e(get_option('whatsapp_sub_text')); ?>" name="whatsapp_sub_text">
                    </div>
                </div>
                            ...
                            <div class="col-sm-6">
                                ...
                                <div class="checkbox">
                                    <label>
                                        ...
                                        <input type="checkbox" name="whatsapp_enabled" value="TRUE" <?php echo e(settingEnabled('whatsapp_enabled') ? 'checked' : ''); ?>>
                                        <span class="label-text" data-rel="tooltip" title="Enable WhatApp Integration."><?php echo trans('app.'.'whatsapp_enabled'); ?> <?php echo e(svg_image('brands/whatsapp','text-success')); ?> </span>
                                    </label>
                                </div>
                            ...
                            <div class="col-sm-6">
                                ...
                                <div class="checkbox">
                                    <label>
                                        ...
                                        <span class="label-text" data-rel="tooltip" title="This action will automatically fetch daily exchange rates for foreign currencies."><?php echo trans('app.'.'update_xrates'); ?>  </span>
                                    </label>
                                </div>
                                ...
                                <div class="checkbox">
                                    <label>
                                        ...
                                        <span class="label-text" data-rel="tooltip" title="Enable Google ReCaptcha."><?php echo trans('app.'.'use_recaptcha'); ?> </span>
                                    </label>
                                </div>
