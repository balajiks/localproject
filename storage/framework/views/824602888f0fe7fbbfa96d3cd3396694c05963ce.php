...
<head>
    ...
    <?php if(get_option('site_appleicon') != ''): ?>
        ...
        <link rel="apple-touch-icon" sizes="72x72" href="<?php echo e(get_option('site_url')); ?><?php echo e(getStorageUrl(config('system.media_dir').'/'.get_option('site_appleicon'))); ?>"/>
        <link rel="apple-touch-icon" sizes="114x114" href="<?php echo e(get_option('site_url')); ?><?php echo e(getStorageUrl(config('system.media_dir').'/'.get_option('site_appleicon'))); ?>"/>
        <link rel="apple-touch-icon" sizes="144x144" href="<?php echo e(get_option('site_url')); ?><?php echo e(getStorageUrl(config('system.media_dir').'/'.get_option('site_appleicon'))); ?>"/>
    <?php endif; ?>


    <meta name="csrf-token" content="<?php echo e(csrf_token()); ?>">

    <title><?php echo e(config('app.name', 'Embase Work Flow')); ?></title>
    ...
    <?php if(settingEnabled('show_login_image')): ?>
        <style type="text/css">
            .content:before, #login-blur {
                background-image: url("<?php echo e(get_option('site_url')); ?><?php echo e(getStorageUrl(config('system.media_dir').'/'.get_option('login_bg'))); ?>");
            }
        </style>
    <?php endif; ?>
