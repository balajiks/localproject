...
<head>
    ...
    <title>{{ config('app.name', 'EmbaseCRM') }}</title>
        ...
        Embase Work Flow
            ...
            <section class="panel panel-default bg-white-cust m-t-lg b-r-cust">
                ...
                <div class="alert alert-danger">
                    @langapp('enter_purchase_code') <a href="https://google.com">Embase Work Flow</a>
                  </div>
                ...
                @if (get_option('hide_branding') == 'FALSE') 
                    <footer id="footer copyright-footer">
                        <div class="text-center text-muted padder">
                            <p>
                                <small>Powered by <a href="{{ config('system.saleurl') }}" target="_blank">Embase Work Flow</a> v{{ getCurrentVersion()['version'] }}
                                    <br>&copy; {{  date('Y')  }} 
                                </small>
                            </p>
                        </div>
