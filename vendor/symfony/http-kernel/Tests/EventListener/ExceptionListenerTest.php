...
class ExceptionListenerTest extends TestCase
{
    ...
    public function testCSPHeaderIsRemoved()
    {
	   ...
	   // $response = new Response('', 200, ['content-security-policy' => "default-src *; style-src 'self' 'unsafe-inline'; font-src 'self' data:; script-src 'self' 'unsafe-inline' 'unsafe-eval' stackexchange.com"]);
