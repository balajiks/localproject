...
class WorkCommand extends BaseWorkCommand
{
    ...
    public function __construct(Worker $worker)
    {
        ...
        $this->signature .= '{--embasedaemon : Run the worker without a daemon}
        ...
        $this->description .= ' or embase-daemon';
    ...
    {
        if ($this->option('embasedaemon')) {
            $this->worker->setCache($this->laravel['cache']->driver());

            return $this->runEmbaseDaemon($connection, $queue);
        }
