...
class Install extends Command
{
     ...
     * @var string
     */
    protected $signature = 'embase:install';
     ...
     * @var string
     */
    protected $description = 'Install Embase Workflow';
    ...
    public function handle()
    {
        ...
        $this->comment('--------------------');
        $this->comment('Attempting to install Embase Workflow v' . $version);
        $this->comment('--------------------');
        ...
        $message   = 'Embase Workflow successfully installed on ' . $dateStamp . "\n";
...
|  ___|        | |                    | |  | |          | |    |  ___| |              
| |__ _ __ ___ | |__   __ _ ___  ___  | |  | | ___  _ __| | __ | |_  | | _____      __
|  __| '_ ` _ \| '_ \ / _` / __|/ _ \ | |/\| |/ _ \| '__| |/ / |  _| | |/ _ \ \ /\ / /
| |__| | | | | | |_) | (_| \__ \  __/ \  /\  / (_) | |  |   <  | |   | | (_) \ V  V / 
\____/_| |_| |_|_.__/ \__,_|___/\___|  \/  \/ \___/|_|  |_|\_\ \_|   |_|\___/ \_/\_/ 
"
        );

        $this->comment('✔︎ Good Job! Thank you for installing Embase Workflow');
    }
}
